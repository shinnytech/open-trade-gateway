...
namespace KingstarAPI
{
	...
	public:
		...
		///        0x2001 接收心跳超时
		///        0x2002 发送心跳失败
		///        0x2003 收到错误报文-因多点上限原因被登出
		///        0x2004 收到错误报文-因系统初始化等原因被登出
	...
	public:
		...
		#ifdef __ANDROID__
		//仅限Android版本使用
		virtual CKSCosApi * LoadCosApi(CKSCosSpi *pSpi) = 0;  
		virtual CKSOptionApi * LoadOptApi(CKSOptionSpi *pSpi) = 0;  
		virtual CKSVocApi * LoadVocApi(CKSVocSpi *pSpi) = 0;  
		virtual CKSPrdApi * LoadPrdApi(CKSPrdSpi *pSpi) = 0;  
		#else
