...
namespace KingstarAPI
{
	...
	struct CThostFtdcReqUserLoginField
	{
		...
		///终端信息
		TThostFtdcUserSystemInfoType UserSystemInfo;
	};
	...
	struct CThostFtdcInstrumentField
	{
		...
		///挂牌基准价格
		TThostFtdcPriceType	BasisPrice;
	};
	...
	struct CThostFtdcExecOrderField
	{
		...
		TThostFtdcMacAddressType	MacAddress;
		///投机套保标志1
		TThostFtdcHedgeFlagType	FirHedgeFlag;		
		///投机套保标志2
		TThostFtdcHedgeFlagType	SecHedgeFlag;		
		///投机套保标志3
		TThostFtdcHedgeFlagType	ThirHedgeFlag;		
		///投机套保标志4
		TThostFtdcHedgeFlagType	FourHedgeFlag;
	};
	...
	struct CThostFtdcInputCombActionField
	{
		...
		TThostFtdcMacAddressType	MacAddress;
		///买卖标记1
		TThostFtdcDirectionType	FirDirection;
		///买卖标记2
		TThostFtdcDirectionType	SecDirection;
		///交易编码
		TThostFtdcClientIDType	ClientID;
	};
	...
	struct CThostFtdcContractBankField
	{
		...
		TThostFtdcBankNameType	BankName;
		///银行英文名称
		TThostFtdcBankNameType	BankEnName;
	};
